...
Выясните при помощи anova есть ли значимое отличие в содержании белка в семенах разных мутантов сои на основании данных из файла [CaseStudy2_Bean_MutantProteinContent_Data.csv](https://github.com/Vladm0z/HSE-Bioinformatics/blob/main/Bioinformatics/MSc/introR/CaseStudy2_Bean_MutantProteinContent_Data.csv).
- Решите в матричной форме
- Решите через средние
- Посчитайте объясненную вариабельность и f-статистику без функции anova
- Проверьте себя при помощи lm-anova
